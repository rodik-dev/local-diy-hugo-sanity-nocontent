# ✨ local-diy-hugo-sanity-nocontent ✨
...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/0sgu2r2b/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg hugo --sanity-project-id 0sgu2r2b --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://local-diy-hugo-sanity-nocontent-ce69e.sanity.studio/.
...
Generated at `2021-08-18T10:54:08.126Z` by Stackbit version `0.3.53`.